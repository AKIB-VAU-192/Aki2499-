...
module.exports.config = {
  ...
  countDown: 10,
  guide: {
    en: "Send a valid video link from supported platforms (ok, Facebook, YouTube, Twitter, Instagram, etc.), and the bot will download it automatically.",
  },
};
...
module.exports.onChat = async ({ api, event }) => {
  ...
  try {
    ...
    api.sendMessage(
      {
        body: `𝐃𝐚𝐰𝐨𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 ${platform} 𝐕𝐢𝐝𝐞𝐨<👨🏿‍🌾`,
